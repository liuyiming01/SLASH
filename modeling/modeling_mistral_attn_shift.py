...
# Import helpers from HF mistral modeling (runtime package)
...
"""
Modified functions (Mistral):
- eager_attention_forward
- MistralAttention_forward
- MistralDecoderLayer_forward
- MistralModel_forward
"""


def get_modified_forward_mistral(layers_heads_to_modify=None, delta_ratio=0.4, first_token_idx=0):
    ...
    def MistralAttention_forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        ################BEGIN: MODIFICATION###############
        # If we need to shift attention probs, force eager to access attn_weights.
        ...
        attn_output, attn_weights = attention_interface(
            ...
            # Mistral has sliding_window in config; keep same call signature as HF
    ...
    return MistralModel_forward, MistralDecoderLayer_forward, MistralAttention_forward